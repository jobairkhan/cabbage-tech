                        ...
                        <div className="row">   
                            ...
                            <div className="col-md-12">
                                ...
                                <p className="minimize">
                                    Jobair Khan accumulated regional and international experience exceeding 10 years of proficiency in team management, software development, project planning, ERP, IT service management and his operation<span>... </span><a href="#." className="more">Show More</a><span style={{ display: 'none' }}>al excellence by managing enterprise level project in PMI framework also drives the quality assurance initiatives for the company. His volume of experience, aptitude and adroit decision-making has culminated into several leading executive positions and board memberships. <a href="#." className="less">Show Less</a></span>
                                </p>
                            </div>
                        </div>
